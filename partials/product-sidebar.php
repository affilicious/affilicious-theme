                        ...
                        <div class="row">
                            <div class="col-xs-6 col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="shop-thumbnail">
                                    <?php if(isset($shop['thumbnail_id'])): ?>
                                        <?php echo wp_get_attachment_image($shop['thumbnail_id'], 'small'); ?>
                                    <?php else: ?>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="shop-info">
                                    <?php if(aff_is_shop_available($shop) && $price = $shop['pricing']['price']): ?>
                                        <div class="shop-price">
                                            <?php if($old_price = $shop['pricing']['old_price']): ?>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="shop-buy">
                                    <?php if(aff_is_shop_available($shop)): ?>
                                        <a class="btn btn-buy" href="<?php echo $shop['tracking']['affiliate_link']; ?>"  rel="nofollow" target="_blank">
                                            <?php echo sprintf(__('Buy now at %s', 'affilicious-theme'), $shop['name']); ?>
                                        </a>
                                    <?php else: ?>
                                        <a class="btn btn-not-available" href="<?php echo $shop['tracking']['affiliate_link']; ?>"  rel="nofollow" target="_blank">
